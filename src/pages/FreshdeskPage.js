...
const FreshdeskPage = () => {
  ...
  // Custom App Integration Content
  const renderCustomAppIntegration = () => (
  ...
  const renderComingSoon = () => (
    <div className="coming-soon-container">
      ...
      <div className="coming-soon-description">
        <p>We're working hard to bring you <strong>{getTitle()}</strong> for Freshdesk integration.</p>
  ...
  return (
    <div className="integration-page">
      <div className="container">
        {option === 'custom-app-integration' ? (
          <div className="content-card-no-header">
            {renderCustomAppIntegration()}
          </div>
        ) : (
          <>
